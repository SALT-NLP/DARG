...
from prompt import prompt_attributes_negative
...
parser.add_argument(
    "--output_file",
    default="bbq_negative_attributes.json",
    type=str,
)
...
if os.path.exists(args.output_file):
    ...
    with open(args.original_file, "r") as file:
        for line in file:
            ...
            data["Negative Attributes"] = {}
            for non_unknown_idx in non_unknown_idxs:
                data["Negative Attributes"][non_unknown_idx] = []
            output_data.append(data)


template = prompt_attributes_negative
response_schemas = [
...
with get_openai_callback() as cb:
    for i, data in enumerate(output_data):
        print(data["Negative Attributes"].keys())
        for non_unknown_idx, attributes_values in data["Negative Attributes"].items():
            ...
            data["Negative Attributes"][non_unknown_idx] = parsed_output
